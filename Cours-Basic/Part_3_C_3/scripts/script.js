...
function lancerJeu() {
    ...
    const btnValiderMot = document.querySelector("#btnValiderMot")
    btnValiderMot.addEventListener("click", () => {
        const inputEcriture = document.querySelector("#inputEcriture")


        console.log(`oui oui sosuure ${inputEcriture.value}`)
